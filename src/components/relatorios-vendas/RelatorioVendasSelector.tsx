...
interface RelatorioVendasSelectorProps {
  tipoRelatorio: TipoRelatorioVendas | null;
  setTipoRelatorio: (tipo: TipoRelatorioVendas | null) => void;
  dataInicio: Date;
...
export function RelatorioVendasSelector({
  tipoRelatorio,
  setTipoRelatorio,
  dataInicio,
  setDataInicio,
      ...
      <CardContent className="pt-6">
        <div className="flex flex-col md:flex-row gap-4 items-end">
          <div className="flex-1 space-y-2">
            ...
            <Select
              value={tipoRelatorio || ""}
              onValueChange={(value) => setTipoRelatorio(value as TipoRelatorioVendas)}
            >
              <SelectTrigger>
